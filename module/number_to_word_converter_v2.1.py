...
def hundred_thousand(given_number):  # 1 hundred thousand = 100,000 / ১ লক্ষ = ১,০০,০০০
...
def million(given_number):  # 1 million = 1,000,000 / ১০ লক্ষ = ১০,০০,০০০
